...
<body>
  ...
  <div class="actions">
    ...
    <form method="post" action="/actions/clean-orphans" onsubmit="return confirm('Are you sure you want to clean up orphaned workers?');"><button type="submit">Clean orphaned workers</button></form>
  </div>
  <h2>Workers</h2>
