...
<body>
  ...
  <div class="actions">
    ...
    <form method="post" action="/actions/stop-cluster" onsubmit="return confirm('Are you sure you want to stop the cluster?');"><button type="submit">Stop cluster</button></form>
